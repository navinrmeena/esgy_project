    ...
    <section id='About' className=' bg-cover bg-center overflow-hidden'>
      <div className='container mx-auto max-w-7xl px-4 relative z-1'>
        <div className='p-12 bg-grey rounded-3xl'>
          ...
          <h2 className='text-center pb-12'>Custom Technology Solutions Built to Scale</h2>
            ...
            {loading
              ...
              : about.map((item, i) => (
                  <div
                    ...
                    <button
                      onClick={openModal}
                      className='text-18 font-semibold text-primary hover-underline flex items-center bg-transparent border-0 hover:cursor-pointer'>
                      {item.link}
                      <Icon
