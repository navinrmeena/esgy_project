    ...
    <section id='services-section'>
      <div className='container mx-auto max-w-7xl px-4'>
        <h2 className='text-center '>
          Transparent Pricing Models for Growing Businesses.
        </h2>
        {/*  */}
          ...
          <div className='flex flex-col sm:flex-row gap-5 md:justify-evenly mt-20 items-start mx-auto'>
            ...
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Flexible Monthly Contracts</p>
            </div>
            <div className='flex gap-5 items-center justify-center md:justify-start'>
              <Image
                src='/images/manage/right.svg'
                ...
                height={14}
              />
              <p className='text-lg font-semibold'>Cancel or Scale Anytime</p>
            </div>
          </div>
        </div>
        {/*  */}
          ...
          {loading
            ...
            : filteredData.map((items, i) => (
                <div
                  ...
                  <button
                    onClick={openModal}
                    className='text-sm font-bold text-primary bg-transparent hover:bg-primary hover:text-white border-2 border-primary rounded-full py-4 px-12 mb-6 hover:cursor-pointer'>
                    Get Started Now
                  </button>
